...
module UniversalImporter
  ...
  class PolyReduction
    ...
    def apply_polygon_reduction
      ...
      raise "MTL file not found: #{export_mtl_path}" unless File.exist?(export_mtl_path)
      ...
      raise "OBJ MTL file not found: #{export_obj_mtl_path}" unless File.exist?(export_obj_mtl_path)
    ...
    def delete_temp_dir
      ...
      if File.exist?(@temp_dir) && File.directory?(@temp_dir)
